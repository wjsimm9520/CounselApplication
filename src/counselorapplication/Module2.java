...
public class Module2 extends JFrame implements ActionListener, WindowListener, FocusListener{
  
    Connection conn = null;
    ResultSet rs = null;
    PreparedStatement pst = null;
    String caz, caz2, s, sx, caz3, caz4, s1, sx1, s2, s4, s6, group2, group3;
    ...
    public Module2() {
        ...
        label1.setText("Network Structure-Processes Group 2");
        p1.add(label1);
        ...
        p1.add(cmdgroup2);
        cmdgroup2.setBounds(454, 137, 160, 35);
        ...
        e1.setText("Emotional Resources Group 2");
        p2.add(e1);
        ...
        f1.setText("Financial Resources Group 2");
        p3.add(f1);
        ...
        d1.setText("Drug Habits Group 2");
        p4.add(d1);
        ...
        c1.setText("Cultural Resources Group 2");
        p5.add(c1);
        ...
        llabel1.setText("Network Structure-Processes Group 3");
        p6.add(llabel1);
        ...
        ee1.setText("Emotional Resources Group 3");
        p7.add(ee1);
        ...
        ff1.setText("Financial Resources Group 3");
        p8.add(ff1);
        ...
        dd1.setText("Drug Habits Group 3");
        p9.add(dd1);
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource() == cmdnext2) {
            ...
            Module2.this.cmdprevious2ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdclear1) {
            Module2.this.cmdclear1ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdclear2) {
            Module2.this.cmdclear2ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdclear3) {
            Module2.this.cmdclear3ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdclear4) {
            Module2.this.cmdclear4ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdclear5) {
            Module2.this.cmdclear5ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdclear6) {
            Module2.this.cmdclear6ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdclear7) {
            Module2.this.cmdclear7ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdclear8) {
            Module2.this.cmdclear8ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdclear9) {
            Module2.this.cmdclear9ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdclear10) {
            Module2.this.cmdclear10ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdsubmit1) {
            Module2.this.cmdsubmit1ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdsubmit2) {
            Module2.this.cmdsubmit2ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdsubmit3) {
            Module2.this.cmdsubmit3ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdsubmit4) {
            Module2.this.cmdsubmit4ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdsubmit5) {
            Module2.this.cmdsubmit5ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdsubmit6) {
            Module2.this.cmdsubmit6ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdsubmit7) {
            Module2.this.cmdsubmit7ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdsubmit8) {
            Module2.this.cmdsubmit8ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdsubmit9) {
            Module2.this.cmdsubmit9ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdsubmit10) {
            Module2.this.cmdsubmit10ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdgroup2) {
            Module2.this.cmdgroup2ActionPerformed(evt);
        }
        else if (evt.getSource() == cmdgroup3) {
            Module2.this.cmdgroup3ActionPerformed(evt);
        }
    }
    ...
    public void windowOpened(java.awt.event.WindowEvent evt) {
        if (evt.getSource() == Module2.this) {
            try {
                Module2.this.formWindowOpened(evt);
    ...
    public void focusLost(java.awt.event.FocusEvent evt) {
        if (evt.getSource() == txtbirthdate) {
            ...
            Module2.this.txtbirthdate6FocusLost(evt);
        }
    }
    ...
    public void cmdsubmit1ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        String sql = "insert into social_network2 (Name, Birth_Date, Main_Group, People_in_Network, Know_in_Network, Closely_Know, Hang_With_Regulary, Hang_with_Amount, Know_Outside_Groups, Connect_outdside_Group, Other_Conn, Closeness, Personal_closeness, Group_Jealousy) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
        try {
            pst = conn.prepareStatement(sql);
            pst.setString(1, txtname.getText());
            pst.setString(2, txtbirthdate.getText());
    ...
    public void cmdsubmit2ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        String sql = "insert into emotional_resources2 (Name, Birth_Date, Main_Group, Discussing_Problems, Honesty_in_Group, Criticism_in_Group, Emotional_GroupMmber, Trust_GroupMmber, Accept_Faults) values(?, ?, ?, ?, ?, ?, ?, ?, ?);";
        try {
            pst = conn.prepareStatement(sql);
    ...
    public void cmdsubmit3ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        String sql = "insert into financial_resources2 (Name, Birth_Date, Main_Group, Lend_Money, Lend_Car, Live_With, Legal_Advice_LoCost, Help_Pay_Bills, Help_Child_Care) values(?, ?, ?, ?, ?, ?, ?, ?, ?);";
        try {
            pst = conn.prepareStatement(sql);
    ...
    public void cmdsubmit4ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        String sql = "insert into group_drug_habits2 (Name, Birth_Date, Main_Group, Arrives_Drunk_High, Drug_Dealers_OutsideGr, Recr_Drug_Use, Party_Exces_Drink, Unwind_With_Drug, DUI_InGroup) values(?, ?, ?, ?, ?, ?, ?, ?, ?);";
        try {
            pst = conn.prepareStatement(sql);
    ...
    public void cmdsubmit5ActionPerformed(java.awt.event.ActionEvent evt) {                                        
       String sql = "insert into cultural_resources2 (Name, Birth_Date, Main_Group, Discuss_hobbies, Volunteer_Work, Cultural_Events, Important_Connts, College_Educated, Library_Use) values(?, ?, ?, ?, ?, ?, ?, ?, ?);";
        try {
            pst = conn.prepareStatement(sql);
    ...
    public void cmdsubmit6ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        String sql = "insert into social_network3 (Name, Birth_Date, Main_Group, People_in_Network, Know_in_Network, Closely_Know, Hang_With_Regulary, Hang_with_Amount, Know_Outside_Groups, Connect_outdside_Group, Other_Conn, Closeness, Personal_closeness, Group_Jealousy) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
        try {
            pst = conn.prepareStatement(sql);
            pst.setString(1, txtname6.getText());
            pst.setString(2, txtbirthdate6.getText());
    ...
    public void cmdsubmit7ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        String sql = "insert into emotional_resources3 (Name, Birth_Date, Main_Group, Discussing_Problems, Honesty_in_Group, Criticism_in_Group, Emotional_GroupMmber, Trust_GroupMmber, Accept_Faults) values(?, ?, ?, ?, ?, ?, ?, ?, ?);";
        try {
            pst = conn.prepareStatement(sql);
    ...
    public void cmdsubmit8ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        String sql = "insert into financial_resources3 (Name, Birth_Date, Main_Group, Lend_Money, Lend_Car, Live_With, Legal_Advice_LoCost, Help_Pay_Bills, Help_Child_Care) values(?, ?, ?, ?, ?, ?, ?, ?, ?);";
        try {
            pst = conn.prepareStatement(sql);
    ...
    public void cmdsubmit9ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        String sql = "insert into group_drug_habits3 (Name, Birth_Date, Main_Group, Arrives_Drunk_High, Drug_Dealers_OutsideGr, Recr_Drug_Use, Party_Exces_Drink, Unwind_With_Drug, DUI_InGroup) values(?, ?, ?, ?, ?, ?, ?, ?, ?);";
        try {
            pst = conn.prepareStatement(sql);
    ...
    public void cmdsubmit10ActionPerformed(java.awt.event.ActionEvent evt) {                                        
       String sql = "insert into cultural_resources3 (Name, Birth_Date, Main_Group, Discuss_hobbies, Volunteer_Work, Cultural_Events, Important_Connts, College_Educated, Library_Use) values(?, ?, ?, ?, ?, ?, ?, ?, ?);";
        try {
            pst = conn.prepareStatement(sql);
    ...
    public void cmdgroup2ActionPerformed(java.awt.event.ActionEvent evt) { 
       String sql = "SELECT * FROM sociogram WHERE Name = ? AND Birth_Date = ?;";
        try {
            ...
            rs = pst.executeQuery();
            while (rs.next()){
            s4 = rs.getString("Second_Group");
            txtgroup1.setText(s4);
            group2 = txtgroup1.getText();
            }
        }catch (SQLException e){} 
        try {
            if (group2.equals(s4)) { 
    ...
    public void cmdgroup3ActionPerformed(java.awt.event.ActionEvent evt) { 
       String sql = "SELECT * FROM sociogram WHERE Name = ? AND Birth_Date = ?;";
        try {
            ...
            rs = pst.executeQuery();
            while (rs.next()){
            s6 = rs.getString("Third_Group");
            txtgroup16.setText(s6); 
            group3 = txtgroup16.getText();
            }
        }catch (SQLException e){} 
        try {
            if (group3.equals(s6)) { 
